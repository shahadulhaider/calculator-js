...
var calculator = new _calculator.default(previousOperandTextElement, currentOperandTextElement);
document.addEventListener('keydown', function (event) {
  event.preventDefault();

  var numKeys = _toConsumableArray(Array(10)).map(function (_, i) {
    return i.toString();
  }).concat('.');
...
},{"./calculator":"src/calculator.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
